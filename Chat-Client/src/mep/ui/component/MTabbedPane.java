...
/**
 * Créer un JTabbedPane avec un bouton de fermeture et avec la meme tete que ceux de swt
 *
 */
public class MTabbedPane extends JTabbedPane  {
    ...
    /**
     * 
     * @param selectedColor : couleur de l'onglet selectionné
     * @param noneSelectedColor : couleur des onglets non selectionnés
     */
    ...
    /**
     * 
     * Lance un evenement a tous les ecouteurs lorsque q'un onglet a été fermé
     * 
     * @param object
     */
     ...
     * @param constraint : contrainte qui definit la présence de la croix de fermeture ou non
     */
     ...
     * @param component : composant que contient l'onglet
     * @param constraint : contrainte qui definit la présence de la croix de fermeture ou non
     * @param icone : icone a afficher du coté gauche du texte
     */
