...
class AjouterPane_textNom_actionAdapter implements java.awt.event.ActionListener {
  AjouterPane adaptee;
...
class AjouterPane_btOK_actionAdapter implements java.awt.event.ActionListener {
  AjouterPane adaptee;
...
class AjouterPane_btCancel_actionAdapter implements java.awt.event.ActionListener {
  AjouterPane adaptee;
